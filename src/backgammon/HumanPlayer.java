				...
				if ( position > -1 && position < 26 )
				{
					...
					if ( Board.playingBoard[position] < 0 )
					{
						...
						if ( Board.playingBoard[position - move] < 1 )
						{
							...
							Board.playingBoard[position - move] -= 1;// adds a new black man to the board
						...
						else if ( Board.playingBoard[position - move] == 1 )
						{
							...
							Board.playingBoard[position + move] -= 2; // Replace white man with a black Man
							//updates bar for white man has 1 piece
